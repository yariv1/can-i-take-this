...
// Anchor on the LAST bare <script> block — the checker script, not gtag/AdSense
const _allScripts = [...html.matchAll(/<script>([\s\S]*?)<\/script>/g)];
const CHK_SCRIPT_M = _allScripts[_allScripts.length - 1] || null;
