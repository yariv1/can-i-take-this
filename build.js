...
.hdr-blog-link{font-family:Inter,sans-serif;font-size:12px;font-weight:600;color:var(--muted);text-decoration:none;padding:6px 10px;border:1px solid var(--line);border-radius:999px;background:var(--surface);margin-left:6px;transition:color .18s,border-color .18s}.hdr-blog-link:hover{color:var(--accent);border-color:var(--accent)}
</style></head><body>
<button class="theme-toggle" id="themeToggle" onclick="__tt()"><span id="themeIcon">&#9788;</span> <span id="themeLabel">Light</span></button><a href="/blog/" class="hdr-blog-link">Blog</a>
<div class="wrap">
...
+'<button class="theme-toggle" id="themeToggle" onclick="__tt()"><span class="ico" id="themeIcon">&#9728;</span><span id="themeLabel">Light</span></button><a href="/blog/" class="hdr-blog-link">Blog</a></div>\n'
