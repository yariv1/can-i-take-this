...
.hdr-blog-link{font-family:Inter,sans-serif;font-size:12px;font-weight:600;color:var(--muted);text-decoration:none;padding:6px 10px;border:1px solid var(--line);border-radius:999px;background:var(--surface);margin-right:6px;transition:color .18s,border-color .18s}.hdr-blog-link:hover{color:var(--accent);border-color:var(--accent)}
</style></head><body>
<a href="/blog/" class="hdr-blog-link" style="position:fixed;top:12px;right:90px;z-index:99;">Blog</a><button class="theme-toggle" id="themeToggle" onclick="__tt()"><span id="themeIcon">&#9788;</span> <span id="themeLabel">Light</span></button>
<div class="wrap">
...
+'<a href="/blog/" class="hdr-blog-link">Blog</a><button class="theme-toggle" id="themeToggle" onclick="__tt()"><span class="ico" id="themeIcon">&#9728;</span><span id="themeLabel">Light</span></button></div>\n'
...
.tlinks{margin-top:.7em;text-align:center;line-height:2}.tlinks a{color:#8A96B8;text-decoration:none}.tlinks a:hover{color:var(--accent)}.tlinks a+a::before{content:"•";color:#8A96B8;margin:0 10px}
.hdr-blog-link{font-family:Inter,sans-serif;font-size:12px;font-weight:600;color:var(--muted);text-decoration:none;padding:6px 10px;border:1px solid var(--line);border-radius:999px;background:var(--surface);margin-right:6px;position:fixed;top:12px;right:90px;z-index:99;transition:color .18s,border-color .18s}.hdr-blog-link:hover{color:var(--accent);border-color:var(--accent)}
</style></head><body>
<a href="/blog/" class="hdr-blog-link">Blog</a>
${CHK_BODY}
<div class="seo">
...
<a href="/blog/" class="hdr-blog-link">Blog</a><button class="theme-toggle" id="themeToggle" onclick="__tt()"><span id="themeIcon">&#9788;</span> <span id="themeLabel">Light</span></button>
<div class="wrap">
<header><a href="/" class="back" aria-label="Back to home">&#8249;</a><a href="/" class="logo">canitakethis.co</a></header>
<main>
<h1>${esc(h1)}</h1>
